...
if __name__ == "__main__":
    ...
    with open("logs/transcript_gtranslate_baseline.txt", "w") as f, open("logs/gtranslate_sentences.txt", "w") as f2:
        ...
        for lang in tqdm(covost2_langs.keys()):
            ...
            # Load the dataset
            dataset = load_dataset("covost2", lang, data_dir="data/"+lang_name, split="test")
            ...
            for item in tqdm(dataloader):
                ...
                translation = client.translate(item["sentence"], source_language=lang_name, target_language='en')['translatedText']
